...
In base alle funzioni utilizzate, Holymp puo trattare le seguenti categorie di dati.
...
Nota: parte dei dati sopra (es. peso, stato benessere, infortuni dichiarati, dati allenamento/nutrizione) puo rientrare nei dati relativi alla salute.
...
3. Adempimenti normativi, fiscali e richieste dell'autorita competente.  
...
- **AI testo/immagini (quando usata la funzione AI)**: provider configurati lato backend (es. OpenAI e/o DeepSeek, in base alla configurazione attiva).
- **Database alimenti esterno (quando usato)**: OpenFoodFacts.
- **Invio email tecniche (es. reset password)**: provider SMTP configurato dal Titolare (es. servizio email transazionale).
...
Tali output hanno funzione di supporto informativo e non sostituiscono valutazioni professionali mediche o sanitarie.
